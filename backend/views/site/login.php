    ...
    <div class="panel-body">
      ...
      <div class="or">or</div>
        <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
            ...
            <?= $form->field($model, 'username',['inputOptions'=>['placeholder'=>'请输入账号'],'inputTemplate'=>'<div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i></span>{input}</div>'])->textInput(['autofocus' => true])->label(false) ?>
