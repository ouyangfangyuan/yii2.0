...
<div class="panel">
            ...
            <div class="row">
                <div class="col-lg-4 label-img-size">
                    <a href="#" class="post-label">
                        <img src="<?=($list['label_img']?\Yii::$app->params['upload_url'].$list['label_img']:\Yii::$app->params['default_label_img'].$list['label_img'])?>" alt="<?=$list['title']?>">
                    </a>
                </div>
    ...
    <div class="page col-lg-offset-10"><?=LinkPager::widget(['pagination' => $data['page']]);?></div>
    <?php endif;?>
</div>